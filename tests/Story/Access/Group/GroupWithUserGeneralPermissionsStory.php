...
class GroupWithUserGeneralPermissionsStory extends Story
{
    public function build(): void
    {
        ...
        $permissionCollection->add(new GroupPermissionDto(context: Context::USER, permission: Permission::UPDATE));
